...
var chapterIndex = function() {
  ...
  $(indexMarkup).addClass( "index row" );
  ...
  $( "h1.title" ).each( function( index ) {
    ...
    // @TODO: While we're here, we should add "back to index" links here somewhere
    var backToTop = document.createElement( "a" );
    $(backToTop).addClass("button tiny round");
    backToTop.setAttribute("href", "#top");
    backToTop.setAttribute("title", "Back to index");
...
$("body").prepend(chapterIndex).prepend(documentTop);
