...
// This is my first attempt at js and jquery.
// First, let's pre-pend the intire document with an anchor to mark it as top
var documentTop = document.createElement("a");
// $(documentTop).addClass("hide"); // Hiding the anchor actually hides it from the links as well on some browsers.
...
$( ".section:first" ).addClass( "wrapper large-12 columns" );

$( ".wrapper" ).wrap( "<section id='chapter' class='row'></div>" );
